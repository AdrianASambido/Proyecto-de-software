<template>
  ...
  <section v-else class="container mx-auto p-4 md:p-8 mt-8">
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
      ...
      <h3 class="text-lg font-semibold text-gray-900 mb-2">Inicia sesión para ver tus favoritos</h3>
      <p class="text-gray-600 mb-4">Guarda tus sitios históricos favoritos y accede a ellos fácilmente.</p>
      <router-link
        to="/login"
